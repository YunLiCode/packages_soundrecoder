...
public class SoundRecorder extends Activity implements Button.OnClickListener,
    ...
    private AnimationDrawable wheel_small_left_ani , wheel_small_right_ani ,smallcdcd_ani , smallcdcd2_ani ,big2_ani,big_ani ;
    
    private ImageView wheel_small_left , wheel_small_right ,smallcdcd , smallcdcd2 ,big,big2;
    ...
    private void initResourceRefs() {
        ...
        wheel_small_left=(ImageView)findViewById(R.id.wheel_small_left);
  ...
  //      wheel_small_left_ani.start();
    ...
    private ImageView getTimerImage(char number) {
        ...
        LayoutParams lp = new LayoutParams(50, 60);
        LayoutParams lp2 = new LayoutParams(40, 50);
    //    if (number != ':') {
